...
<head>
	...
	<link href="{{ URL::asset('assets/css/gridster.css')}}" rel="stylesheet">
	...
	<link id="ie-style" href="{{ URL::asset('assets/css/ie.css')}}" rel="stylesheet">
	<![endif]-->

	<!--[if IE 9]>
	<link id="ie9style" href="{{ URL::asset('assets/css/ie9.css')}}" rel="stylesheet">
	<![endif]-->
...
<div class="navbar">
	...
	<script src="{{ URL::asset('assets/js/custom.js')}}"></script>
		...
		<script src="{{ URL::asset('assets/js/gridster.js')}}"></script>
	<!-- end: JavaScript-->
